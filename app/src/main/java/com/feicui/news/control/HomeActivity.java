...
public class HomeActivity extends MyBaseActivity implements ImageLoadListener {
	...
	private void initSlidingMenu() {
		...
		iv_friend = (ImageView) findViewById(R.id.fun_friend);
		iv_qq = (ImageView) findViewById(R.id.fun_qq);
		iv_friends = (ImageView) findViewById(R.id.fun_friends);
		iv_weibo = (ImageView) findViewById(R.id.fun_weibo);
	}
